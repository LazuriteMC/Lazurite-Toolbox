...
public class QuaternionHelper {
    ...
    /**
     * Serializes the given {@link Quaternionf} into a {@link FriendlyByteBuf}.
     * @param buf  the {@link FriendlyByteBuf} to store the {@link Quaternionf} in
     * @param quat the {@link Quaternionf} to store
     */
    public static void toBuffer(FriendlyByteBuf buf, Quaternionf quat) {
    ...
    /**
     * Deserializes the given {@link FriendlyByteBuf} into a new {@link Quaternionf}.
     * @param buf the {@link FriendlyByteBuf} to retrieve the {@link Quaternionf} from
     * @return the new {@link Quaternionf}
     */
    public static Quaternionf fromBuffer(FriendlyByteBuf buf) {
